            ...
            <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
                <div className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
                    <BentoCard
                        ...
                        title={<>zig<b>m</b>a</>}
                        description="The NFT collection merging Zentry's IP, AI, and gaming pushing the boundries of NFT innovation."
                    />
                </div> 
                ...
                <div className="bento-tilt_2">
                    <video src="videos/feature-5.mp4" autoPlay loop muted className="size-full object-cover object-center"/>
